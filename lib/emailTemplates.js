...
export const EMAIL_ADDRESSES = {
  INFO: process.env.SMTP_FROM || 'info@theoaklinebank.com',
  WELCOME: process.env.SMTP_FROM_WELCOME || process.env.SMTP_FROM || 'welcome@theoaklinebank.com',
  UPDATES: process.env.SMTP_FROM_UPDATES || process.env.SMTP_FROM || 'updates@theoaklinebank.com',
  CONTACT: process.env.SMTP_FROM_CONTACT || process.env.SMTP_FROM || 'contact-us@theoaklinebank.com',
  NOTIFY: process.env.SMTP_FROM_NOTIFY || process.env.SMTP_FROM || 'notify@theoaklinebank.com'
};
