...
export async function sendTransferSentEmail({ to, userName, recipientName, amount, reference, accountNumber, userId = null }) {
  const emailHtml = `
    ...
    <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; background-color: #f8fafc;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 40px 32px;">
          <h1 style="color: #059669; font-size: 28px; font-weight: 700; margin: 0 0 16px 0;">
          ...
          <p style="color: #4a5568; font-size: 16px; line-height: 1.6; margin: 0 0 24px 0;">
            Your transfer has been completed successfully. The funds are now available to the recipient.
          </p>

          <div style="background-color: #f0fdf4; border-left: 4px solid #059669; padding: 24px; margin: 24px 0; border-radius: 8px;">
            <h3 style="color: #065f46; font-size: 18px; font-weight: 600; margin: 0 0 16px 0;">Transfer Details</h3>
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Amount:</td>
                <td style="padding: 8px 0; color: #059669; font-size: 18px; font-weight: 700; text-align: right;">$${parseFloat(amount).toFixed(2)}</td>
              </tr>
              <tr>
                <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Recipient:</td>
                <td style="padding: 8px 0; color: #1a365d; font-size: 14px; font-weight: 600; text-align: right;">${recipientName}</td>
              </tr>
              <tr>
                <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Reference #:</td>
                <td style="padding: 8px 0; color: #1a365d; font-size: 14px; font-weight: 600; text-align: right; font-family: monospace;">${reference}</td>
              </tr>
              <tr style="border-top: 1px solid #d1fae5;">
                <td style="padding: 8px 0; color: #6b7280; font-size: 14px; padding-top: 12px;">Time:</td>
                <td style="padding: 8px 0; color: #1a365d; font-size: 14px; text-align: right; padding-top: 12px;">${new Date().toLocaleString()}</td>
              </tr>
            </table>
          </div>

          <p style="color: #4a5568; font-size: 14px; line-height: 1.6; margin: 24px 0;">
            The recipient has been notified about this transfer. If you have any questions, please don't hesitate to contact our support team.
          </p>
        </div>
  ...
  return sendEmail({
    to,
    subject: `💸 Transfer Sent: $${parseFloat(amount).toFixed(2)} to ${recipientName}`,
    html: emailHtml,
...
export async function sendTransferReceivedEmail({ to, userName, senderName, amount, reference, accountNumber, userId = null }) {
    ...
    <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; background-color: #f8fafc;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        <div style="background: linear-gradient(135deg, #1e40af 0%, #3b82f6 100%); padding: 32px 24px; text-align: center;">
          <div style="color: #ffffff; font-size: 32px; margin-bottom: 8px;">💰</div>
          <div style="color: #ffffff; font-size: 28px; font-weight: 700; margin-bottom: 8px;">Oakline Bank</div>
          <div style="color: #ffffff; opacity: 0.9; font-size: 16px;">Transfer Received</div>
        </div>

        <div style="padding: 40px 32px;">
          <h1 style="color: #1e40af; font-size: 28px; font-weight: 700; margin: 0 0 16px 0;">
            ✓ Money Received
          </h1>
          ...
          <p style="color: #4a5568; font-size: 16px; line-height: 1.6; margin: 0 0 24px 0;">
            Great news! You've received a transfer from another Oakline Bank customer. The funds are now available in your account.
          </p>

          <div style="background-color: #f0f9ff; border-left: 4px solid #1e40af; padding: 24px; margin: 24px 0; border-radius: 8px;">
            <h3 style="color: #1e40af; font-size: 18px; font-weight: 600; margin: 0 0 16px 0;">Transfer Details</h3>
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Amount:</td>
                <td style="padding: 8px 0; color: #1e40af; font-size: 18px; font-weight: 700; text-align: right;">$${parseFloat(amount).toFixed(2)}</td>
              </tr>
              <tr>
                <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">From:</td>
                <td style="padding: 8px 0; color: #1a365d; font-size: 14px; font-weight: 600; text-align: right;">${senderName}</td>
              </tr>
              <tr>
                <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">Reference #:</td>
                <td style="padding: 8px 0; color: #1a365d; font-size: 14px; font-weight: 600; text-align: right; font-family: monospace;">${reference}</td>
          ...
          <p style="color: #4a5568; font-size: 14px; line-height: 1.6; margin: 24px 0;">
            You can view this transaction in your account dashboard. If you have any questions about this transfer, please contact our support team.
          </p>
        </div>
  ...
  return sendEmail({
    to,
    subject: `💸 Transfer Received: $${parseFloat(amount).toFixed(2)} from ${senderName}`,
    html: emailHtml,
    emailType: EMAIL_TYPES.NOTIFY,
    userId: userId
  });
