...
export async function sendTransferSentEmail({ to, userName, recipientName, amount, reference, accountNumber, userId = null }) {
      ...
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 40px 32px;">
          ...
          <div style="background: linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%); border: 2px solid #059669; border-radius: 16px; padding: 32px; text-align: center; margin: 32px 0; box-shadow: 0 4px 12px rgba(5, 150, 105, 0.15);">
            ...
            <div style="color: #047857; font-size: 48px; font-weight: 800; margin: 0;">$${parseFloat(amount).toFixed(2)}</div>
          </div>
          ...
          <div style="background-color: #f7fafc; border-radius: 12px; padding: 24px; margin: 24px 0;">
            ...
            <div style="margin-bottom: 16px; padding-bottom: 16px; border-bottom: 1px solid #e2e8f0;">
              ...
              <div style="color: #1a365d; font-size: 18px; font-weight: 700;">${recipientName}</div>
            </div>

            <div style="margin-bottom: 16px; padding-bottom: 16px; border-bottom: 1px solid #e2e8f0;">
              <div style="color: #64748b; font-size: 12px; font-weight: 600; text-transform: uppercase; margin-bottom: 6px;">Reference Number</div>
              <div style="color: #1a365d; font-size: 16px; font-weight: 700; font-family: monospace;">${reference}</div>
            </div>
          ...
          <!-- Success Notice -->
          <div style="background-color: #d1fae5; border-left: 4px solid #059669; padding: 20px; border-radius: 8px; margin: 24px 0;">
            <div style="color: #047857; font-size: 14px; line-height: 1.6;">
              <strong style="font-size: 15px;">✅ Transfer Complete</strong><br/>
              <span style="color: #065f46;">The funds have been instantly delivered to ${recipientName}'s account. The recipient has been notified.</span>
            </div>
          </div>
        </div>
  ...
  return sendEmail({
    to,
    subject: `💸 Oakline Pay Sent - $${parseFloat(amount).toFixed(2)} | Oakline Bank`,
    html: emailHtml,
...
export async function sendTransferReceivedEmail({ to, userName, senderName, amount, reference, accountNumber, userId = null }) {
    ...
    <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; background-color: #f8fafc;">
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 40px 32px;">
          ...
          <!-- Amount Card -->
          <div style="background: linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%); border: 2px solid #059669; border-radius: 16px; padding: 32px; text-align: center; margin: 32px 0; box-shadow: 0 4px 12px rgba(5, 150, 105, 0.15);">
            <div style="color: #047857; font-size: 14px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 12px;">Amount Received</div>
            <div style="color: #047857; font-size: 48px; font-weight: 800; margin: 0;">+$${parseFloat(amount).toFixed(2)}</div>
          </div>
          ...
          <div style="background-color: #f7fafc; border-radius: 12px; padding: 24px; margin: 24px 0;">
            ...
            <div style="margin-bottom: 16px; padding-bottom: 16px; border-bottom: 1px solid #e2e8f0;">
              <div style="color: #64748b; font-size: 12px; font-weight: 600; text-transform: uppercase; margin-bottom: 6px;">From</div>
              <div style="color: #1a365d; font-size: 18px; font-weight: 700;">${senderName}</div>
            </div>
          ...
          <div style="background-color: #d1fae5; border-left: 4px solid #059669; padding: 20px; border-radius: 8px; margin: 24px 0;">
            <div style="color: #047857; font-size: 14px; line-height: 1.6;">
              <strong style="font-size: 15px;">✅ Funds Available Now</strong><br/>
              <span style="color: #065f46;">The money has been instantly deposited into your account and is ready to use.</span>
            </div>
          </div>
        </div>
  ...
  return sendEmail({
    to,
    subject: `💰 Money Received - $${parseFloat(amount).toFixed(2)} | Oakline Bank`,
    html: emailHtml,
    emailType: EMAIL_TYPES.NOTIFY,
    userId: userId
  });
