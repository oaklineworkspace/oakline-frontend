          ...
          <div style={styles.headerContent}>
            ...
            <div style={styles.scrollingAccountContainer}>
              <div style={styles.scrollingAccountText}>
                🎉 Open your Oakline Bank account online in minutes! • 💳 Choose from 23 different account types • 🏦 FDIC Insured up to $250,000 • 📱 Award-winning mobile banking • 🔒 Bank-level security • ⚡ Instant account activation • 🌟 Join over 500,000 satisfied customers
              </div>
            </div>

            <div style={styles.headerActions}>
              <div style={styles.headerButtons}>
                <Link href="/sign-in" style={styles.homeButton}>
