      ...
      <div style={{ width: '100%', maxWidth: '400px', padding: '2rem', border: '1px solid #ccc', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
        ...
        {step === 1 && (
          <form onSubmit={handleVerify}>
            ...
            <input type="date" name="dob" value={formData.dob} onChange={handleChange} required placeholder="Date of Birth" style={{ width: '100%', padding: '0.5rem', margin: '0.5rem 0' }} />
            <input type="text" name="ssnLast4" value={formData.ssnLast4} onChange={handleChange} required maxLength={4} placeholder="Last 4 of SSN" style={{ width: '100%', padding: '0.5rem', margin: '0.5rem 0' }} />
        ...
        {step === 2 && userInfo && (
          <form onSubmit={handleEnroll}>
            ...
            <input type="password" name="password" value={formData.password} onChange={handleChange} required placeholder="Set your password" style={{ width: '100%', padding: '0.5rem', margin: '0.5rem 0' }} />
            <button type="submit" disabled={loading} style={{ width: '100%', padding: '0.75rem', marginTop: '1rem', cursor: 'pointer' }}>
