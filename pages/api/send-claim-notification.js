...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Thank you for submitting your claim! We've received your request and are processing your payment from <strong>${sender_name}</strong>.</p>
      ...
      <p>If you have any questions or concerns, please don't hesitate to contact our support team at <strong>support@theoaklinebank.com</strong>.</p>
    ...
    const mailOptions = {
      ...
      html: htmlContent,
      text: `Payment Claim Submitted\n\nDear ${receiver_name || 'Recipient'},\n\nThank you for submitting your claim! We've received your request and are processing your payment from ${sender_name}.\n\nAmount: $${parseFloat(amount).toFixed(2)}\nClaim Method: ${claimMethodText}\n\nYour claim has been successfully submitted and is currently under review. Funds will be available ${timelineText}.\n\nYou'll receive another email with your payment confirmation.\n\nBest regards,\nOakline Bank Team`,
    };
