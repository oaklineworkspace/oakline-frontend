...
function DashboardContent() {
  ...
  if (typeof document !== 'undefined') {
    ...
    if (!existingStyle) {
      ...
      /* Security Banner Scrolling Animation */
      @keyframes scroll {
        0% {
              ...
              {dropdownOpen.main && (
                <div style={styles.dropdown}>
                  ...
                  <div style={styles.dropdownSection}>
                    ...
                    <Link href="/loan/dashboard" style={styles.dropdownLink}>📊 Loan Dashboard</Link>
                    <Link href="/loans" style={styles.dropdownLink}>📋 View All Loans</Link>
                    <Link href="/loan/apply" style={styles.dropdownLink}>➕ Apply for Loan</Link>
                  ...
                  <div style={{
                    ...
                    <div style={styles.cardFooterDetails}>
                      ...
                      <div>
                        ...
                        <div style={styles.cardValueSmall}>
                          {showCardDetails[card.id] ? (card.cvv || card.cvv || '***') : '***'}
                        </div>
                      </div>
                    </div>
                  </div>
